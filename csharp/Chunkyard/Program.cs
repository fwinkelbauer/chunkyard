...
namespace Chunkyard
{
    public static class Program
    {
        ...
        {
            return Parser.Default.ParseArguments<InitOptions, FilterOptions, CatOptions, RestoreOptions, CreateOptions, VerifyOptions, LogOptions, PushOptions, PullOptions>(args).MapResult(
